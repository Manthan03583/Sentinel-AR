...
- **Styling**: **Tailwind CSS 4** (Custom Industrial Theme: Obsidian & Safety Amber)
- **3D Engine**: `@react-three/fiber` & `@react-three/drei` (Three.js)
- **Animation**: **GSAP** (ScrollTrigger & @gsap/react) for high-performance UI transitions
- **Icons**: Lucide React

## 📐 Project Structure
- `app/`: Next.js App Router for routing and layout.
- `app/sectors/`: Dedicated deep-dives for Mining, Steel, Defense, and Logistics.
- `components/`: Modular, GSAP-optimized UI components (Hero, Kernel, HardSpecs, etc.).
