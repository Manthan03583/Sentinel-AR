...
const SECTOR_DATA = {
  ...
  interventions: [
    ...
    {
      title: "Gas & Thermal Fusion",
      desc: "Visualizing volatile gas pockets and heat zones directly on the visor, allowing for proactive evacuation before alarms sound.",
      icon: Activity
    },
    {
      title: "Wayfinding & Logistics",
      desc: "AR-guided navigation through complex tunnel networks, reducing search-time for equipment and improving emergency response speed.",
      icon: Layers
    }
  ]
};
      ...
      <section className="py-32 px-8 md:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="space-y-12">
            <h2 className="text-4xl font-bold text-white uppercase tracking-tighter">The Mission <br/> <span className="text-amber-500">Objective.</span></h2>
