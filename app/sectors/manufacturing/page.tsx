          ...
          <div className="space-y-12">
            ...
            <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span className="font-mono text-xs text-zinc-300 font-bold tracking-widest uppercase">Atlas V1 Line Telemetry</span>
              </div>
              <p className="text-zinc-500 text-sm leading-relaxed font-medium italic">
                &quot;We&apos;ve reduced our unplanned downtime by nearly 30% by giving our maintenance team &apos;X-ray vision&apos; into our complex assembly units with Sentinel OS.&quot;
              </p>
            </div>
          </div>
